...
# Start Button
start_image = PhotoImage(file="image/play.png")
start_button = Button(text="Start", highlightthickness=0, bg="white", command=start_timer, image=start_image)
start_button.grid(column=0, row=2)

# Reset Button
stop_image = PhotoImage(file="image/stop.png")
reset_button = Button(text="Reset", highlightthickness=0, bg="white", command=reset_timer, image=stop_image)
